 ...
 * @author rqpa
 */
public class ReframingEdgeIterator<T> implements Iterator<T>{
    
    private final Iterator<? extends EdgeFrame> edgeFrameIterator;
    ...
    public boolean hasNext() {
        return edgeFrameIterator.hasNext();
    }

    @Override
    public T next() {
        EdgeFrame next = edgeFrameIterator.next();
        return next == null ? null : next.reframe(framedType);
    }

    @Override
    public void remove() {
        edgeFrameIterator.remove();
    }
