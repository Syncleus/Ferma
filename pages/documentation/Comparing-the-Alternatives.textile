...
h1(#feature-breakdown). Feature Breakdown
...
|_. |_. *Ferma*|_. *Frames*|_. *Totorom*|_. *Peapod*|
|*"JPA-like Annotations":Ferma:Creating_Annotated_Domain_Models*|Supported|Supported|Not Supported|Supported|
|*"Type information encoded into graph.":#Type_information_encoded_into_graph*|Supported|Supported|Supported|Supported|
|*"Framing of elements instantiated according to type hierarchy.":#Framing_instantiated_by_type_hierarchy*|Supported|Supported|Supported|Supported|
|*"Element queried by type hierarchy.":#Element_queried_by_type_hierarchy*|Supported|Not Supported|Not Supported|Partial &#42;|
|*"Turning off type resolution on a per-call basis.":#Turning_off_type_resolution_per-call*|Supported|Not Supported|Not Supported|Not Supported|
|*"Changing the encoded graph type already stored in the database.":#Changing_type_encoded_in_the_graph*|Supported|Not Supported|Not Supported|Not Supported|
|*"Customizing the way type information is stored in the graph":#Customizing_how_types_are_encoded*|Supported|Not Supported|Not Supported|Not Supported|
...
h2(#type-information-encoded-into-graph). Type information encoded into graph
...
h2(#framing-instantiated-by-type-hierarchy). Framing instantiated by type hierarchy
...
h2(#element-queried-by-type-hierarchy). Element queried by type hierarchy
...
h2(#turning-off-type-resolution-per-call). Turning off type resolution per&#45;call
...
h2(#changing-type-encoded-in-the-graph). Changing type encoded in the graph
...
h2(#customizing-how-types-are-encoded). Customizing how types are encoded
