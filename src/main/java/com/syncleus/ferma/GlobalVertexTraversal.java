...
public class GlobalVertexTraversal<C, S, M> implements VertexTraversal<C, S, M> {
    ...
    @Override
    public <N> Traversal<VertexFrame, Collection<? extends N>, N, M> store(final Collection<? super N> storage, final TraversalFunction<VertexFrame, N> storageFunction) {
    ...
    @Override
    public VertexTraversal<Table, Table, M> table(final Table table, final Collection<String> stepNames, final TraversalFunction<?, ?>... columnFunctions) {
