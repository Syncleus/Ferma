...
public interface Traversal<T, C, S, M> extends Iterator<T>, Iterable<T> {
	 ...
	 */
	public abstract Traversal<Map<String, Object>, ?, ?, M> map(String... keys);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> dedup();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> dedup(TraversalFunction<T, ?> dedupFunction);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> except(Iterable<?> collection);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> except(String... namedSteps);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> filter(TraversalFunction<T, Boolean> filterFunction);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> random(double bias);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> range(int low, int high);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> limit(int limit);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> retain(Iterable<?> collection);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> retain(String... namedSteps);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, Collection<? extends T>, Collection<? extends T>, M> aggregate();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, Collection<? extends T>, Collection<? extends T>, M> aggregate(Collection<? super T> aggregate);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <N> Traversal<T, Collection<? extends N>, Collection<? extends N>, M> aggregate(Collection<? super N> aggregate, TraversalFunction<T, ? extends N> aggregateFunction);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <N> Traversal<T, Collection<? extends N>, Collection<? extends N>, M> aggregate(TraversalFunction<T, ? extends N> aggregateFunction);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <K, V> Traversal<T, Map<K, List<V>>, Map<K, List<V>>, M> groupBy(Map<K, List<V>> map,
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <K, V> Traversal<T, Map<K, List<V>>, Map<K, List<V>>, M> groupBy(TraversalFunction<T, K> keyFunction,
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <K, V, V2> Traversal<T, Map<K, V2>, Map<K, V2>, M> groupBy(Map<K, V2> reduceMap,
			TraversalFunction<T, K> keyFunction, TraversalFunction<T, Iterator<V>> valueFunction,
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <K, V, V2> Traversal<T, Map<K, V2>, Map<K, V2>, M> groupBy(TraversalFunction<T, K> keyFunction,
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <K> Traversal<T, Map<K, Long>, Map<K, Long>, M> groupCount(Map<K, Long> map,
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <K> Traversal<T, Map<K, Long>, Map<K, Long>, M> groupCount(TraversalFunction<T, K> keyFunction,
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, Map<T, Long>, Map<T, Long>, M> groupCount(Map<T, Long> map);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, Map<T, Long>, Map<T, Long>, M> groupCount();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> sideEffect(SideEffectFunction<T> sideEffectFunction);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <N> Traversal<T, Collection<N>, N, M> store(Collection<N> storage);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <N> Traversal<T, Collection<N>, N, M> store(Collection<N> storage, TraversalFunction<T, N> storageFunction);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, Collection<T>, T, M> store();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <N> Traversal<T, Collection<N>, N, M> store(TraversalFunction<T, N> storageFunction);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, Table, Table, M> table(Table table, Collection<String> stepNames,
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, Table, Table, M> table(Table table, TraversalFunction<?, ?>... columnFunctions);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, Table, Table, M> table(TraversalFunction<?, ?>... columnFunctions);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, Table, Table, M> table(Table table);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, Table, Table, M> table();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <N> Traversal<T, Tree<N>, Tree<N>, M> tree(Tree<N> tree);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, Tree<T>, Tree<T>, M> tree();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> identity();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> memoize(String namedStep);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> memoize(String namedStep, Map<?, ?> map);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> order();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> order(TransformPipe.Order order);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> order(Tokens.T order);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> order(Comparator<T> compareFunction);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> as(String name);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> simplePath();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, C, S, ? extends Traversal<T, C, S, M>> mark();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> gatherScatter();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<Path, ? , ?, M> path(TraversalFunction<?, ?>... pathFunctions);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<Row<?>, ?, ?, M> select(Collection<String> stepNames, TraversalFunction<?, ?>... columnFunctions);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<Row<?>, ?, ?, M> select(TraversalFunction<?, ?>... columnFunctions);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<Row<?>, ?, ?, M> select();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> shuffle();
	 ...
	 * @return the extended Pipeline
	 */
	public abstract Traversal<T, ?, ?, M> divert(SideEffectFunction<S> sideEffectFunction);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <N> Traversal<? extends N, ?, ?, M> transform(TraversalFunction<T, N> function);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <N> Traversal<N, ?, ?, M> start(N object);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract VertexTraversal<?, ?, M> start(VertexFrame object);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract EdgeTraversal<?, ?, M> start(EdgeFrame object);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <N> Traversal<N, ?, ?, M> property(String key);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract <N> Traversal<? extends N, ?, ?, M> property(String key, Class<N> type);
	 ...
	 */
	public abstract Traversal<T, C, S, M> enablePath();
	 ...
	 */
	public abstract Traversal<T, C, S, M> optimize(boolean optimize);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract EdgeTraversal<?, ?, M> idEdge(Graph graph);
	 ...
	 * @return the extended Pipeline
	 */
	public abstract VertexTraversal<?, ?, M> idVertex(Graph graph);
