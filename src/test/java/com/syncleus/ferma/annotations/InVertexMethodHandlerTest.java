...
import java.util.*;
import com.syncleus.ferma.graphtypes.javaclass.invalid.OneArgGetInVertexEdge;
...
public class InVertexMethodHandlerTest {
    ...
    public void testSingleArgGetMethod() {
        ...
        fg.addFramedEdge(t1, t2, "somename", OneArgGetInVertexEdge.class);
    }
    ...
    public void testNoArgSetMethod() {
        ...
        TVertex t1 = fg.addFramedVertex();
        TVertex t2 = fg.addFramedVertex();
        fg.addFramedEdge(t1, t2, "somename", NoArgSetInVertexEdge.class);
    }
}
